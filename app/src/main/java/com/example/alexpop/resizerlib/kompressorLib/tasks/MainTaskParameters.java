...
public class MainTaskParameters {
    ...
    MainTaskParameters(@NonNull List<File> imageFiles, @NonNull TaskType taskType, @Nullable File toCopyDestinationDirectory, int compressionRatio,
    ...
    public static class MainTaskParametersBuilder {
        ...
        public MainTaskParameters createMainTaskParameters() {
            return new MainTaskParameters(imageFiles, taskType, toCopyDestinationDirectory, compressionRatio, maximumResizeWidth);
        }
    }
}
